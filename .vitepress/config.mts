...
const PILLARS: ReadonlyArray<Pillar> = [
    {   // ① 架构(吸收总览:introduction 系列 + quickstart 概念在此安家)
        ...
        groups: [
            ...
            {key: 'group.appendix', items: [['introduction/glossary'], ['introduction/license'], ['diagrams']]}
        ]
    },
    {   // ② 驱动
...
// 图表总览入口：宫格图标；内部链接的 target 剥离见 theme/index.ts（fixInternalSocialLinks）
const GALLERY_ICON = '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path fill="currentColor" d="M3.5 3.5h7v7h-7v-7zm10 0h7v7h-7v-7zm-10 10h7v7h-7v-7zm10 0h7v7h-7v-7zm-8.5 1.5h4v4h-4v-4zm10-10h4v4h-4v-4zm0 10h4v4h-4v-4zm-10 0h4v4h-4v-4z" opacity=".25"/><path fill="currentColor" d="M3.5 3.5h7v7h-7v-7zm1.5 1.5v4h4v-4h-4zm8.5-1.5h7v7h-7v-7zm1.5 1.5v4h4v-4h-4zM3.5 13.5h7v7h-7v-7zm1.5 1.5v4h4v-4h-4zm8.5-1.5h7v7h-7v-7zm1.5 1.5v4h4v-4h-4z"/></svg>'
...
const socialLinks = (lang: Lang) => [
    ...
    {
        icon: {svg: GALLERY_ICON},
        link: `${lang === 'en' ? '/en' : '/zh'}/diagrams`,
        ariaLabel: lang === 'en' ? 'Diagram index' : '图表总览'
    },
    {
